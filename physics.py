...
S_0 = Quantity(1360, "W m^(-2)")                                        # Average incoming solar shortwave radiation at the top of the atmosphere
Stefan_Boltzmann = Quantity(5.670 * 10**(-8), "W m^(-2) K^(-4)")        # Stefan-Boltzman radiative constant
Planck = Quantity(6.62607015 * 10**(-34), "J s")                        # Planck's radiative constant
c = Quantity(299792458, "m s^(-1)")                                     # The speed of light
Boltzmann = Quantity(1.380649 * 10**(-23), "J K^(-1)")                  # Boltzman radiative constant
r_sun = Quantity(695700000, "m")                                        # Radius of the Sun
D_sun = Quantity(149600000000, "m")                                     # Mean distance from the Earth to the Sun